...
/**
 *  The <tt>IndexedMinPriorityQueue</tt> class represents an indexed priority queue of generic keys.
 ...
 */
public class IndexedMinPriorityQueue<Key extends Comparable<Key>> implements Iterable<Integer> {
